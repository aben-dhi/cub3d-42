...
/*   Updated: 2023/12/09 17:39:39 by aben-dhi         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
//for width and for height we're going to check the first and last character of the map
...
int checkwalls(int x, int y, t_map *map)
 {
    ...
    if (map->map[x][y] == ' ' || map->map[x][y] == '\0' || map->map[x][y] == '\n')
